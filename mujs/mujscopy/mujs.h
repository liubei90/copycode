...
JS_NORETURN void js_referrenceerror(js_State *J, const char *fmt, ...) JS_PRINTFLIKE(2, 3);
...
void js_defglobal(js_State *J, const char *name);
...
int js_jsnumber(js_State *J, int idx);
